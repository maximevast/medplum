  ...
  return ext.extension
    ...
    .map((availTime) => {
      ...
      const start = availTime.extension.find(
        (e): e is { url: 'availableStartTime'; valueTime: WallClockTime } => e.url === 'availableStartTime'
      )?.valueTime;
      const end = availTime.extension.find(
        (e): e is { url: 'availableEndTime'; valueTime: WallClockTime } => e.url === 'availableEndTime'
      )?.valueTime;
